...
class _ListeClientsState extends State<ListeClients> {
  ...
  Widget _appBarTitle =
      Text('Demandes Mastére Franchise', style: TextStyle(fontSize: 14.0));
  ...
  void _searchPressed() {
    setState(() {
      if (this._searchIcon.icon == Icons.search) {
        ...
        this._appBarTitle = new Text('Demandes Mastére Franchise',
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  DrawerItem(
                      ...
                      function: () => ajouterUnFiliale(context)),
                  DrawerItem(
                      function: () => Navigator.of(context).push(
                          MaterialPageRoute(builder: (_) => Affiliates())),
                      icon: Icons.home,
                      label: "liste filiales"),
                  DrawerItem(
    ...
    return WillPopScope(
      ...
      child: SafeArea(
        child: ChangeNotifierProvider.value(
          value: model,
          child: Consumer<MotherModel>(builder: (_, model, child) {
            this._getNames();
            return Scaffold(
              appBar: AppBar(
